...
const authOptions = {
    ...
    providers: [
        github_default()({
            clientId: "b77fdffc35f9838c0adb",
            clientSecret: "419d607168da50c9328eabe894b44f2368e86224"
        })
    ]
};
/* harmony default export */ const _nextauth_ = ((req, res)=>external_next_auth_default()(req, res, authOptions));
...
var __webpack_exports__ = __webpack_require__.X(0, [172], () => (__webpack_exec__(58)));
